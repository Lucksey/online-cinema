...
export class GenreService {
  constructor(@InjectModel(GenreModel) private readonly GenreModel:
                ModelType<GenreModel>,
  ...
  //сервис для получения всех Жанров
  async getAll(searchTerm?: string) {
    ...
    return this.GenreModel.find(options).select( // тут шляпа find
      "-updateAt, -__V").sort({ createdAt: "desc" }).exec();
